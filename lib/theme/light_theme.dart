...
ThemeData light({Color? primaryColor, Color? secondaryColor})=> ThemeData(
  ...
  primaryColor: primaryColor ?? const Color(0xFFDAA520/*0xFF1455AC*/),
  brightness: Brightness.light,
  highlightColor: Colors.white,
  hintColor: const Color(0xFF9E9E9E),
  splashColor: Colors.transparent,
  colorScheme:  ColorScheme.light(
    primary: const Color(0xFFDAA520/*0xFF1455AC*/),
    secondary: const Color(0xFFF4E3B5/*0xFF004C8E*/),
    ...
    outline: const Color(0xFFF4E3B5/*0xff2C66B4*/),
