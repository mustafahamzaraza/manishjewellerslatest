  ...
  Future<void> fetchGoldPrices() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          price24k = "₹${discounted24K.toStringAsFixed(2)}";
          price22k = "₹${price22K.toStringAsFixed(2)}";
          price18k = "₹${price18K.toStringAsFixed(2)}";
