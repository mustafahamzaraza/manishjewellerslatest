...
class ProductDetailsController extends ChangeNotifier {
  ...
  Future<dynamic> getProductDetails(
      BuildContext context, String productID, String slug, String carat) async {
    _isDetails = true;
    notifyListeners();

    ApiResponse apiResponse = await productDetailsServiceInterface.getWithCarat(slug, carat);
