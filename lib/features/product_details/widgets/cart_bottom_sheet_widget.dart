...
class CartBottomSheetWidgetState extends State<CartBottomSheetWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    double? endingPrice = priceRange.end;
     ...
     int normalprice = widget.product!.unitPrice!.toInt();
     int pricwwithdiscount = widget.product!.unitPrice!.toInt() - widget.product!.discount!.toInt();
     // int disprice = normalprice - pricwwithdiscount ?? 0;
        ...
        Container(padding: const EdgeInsets.only(top : Dimensions.paddingSizeSmall),
          ...
          child: Consumer<ProductDetailsController>(
            builder: (ctx, details, child) {
              ...
              //Get total price with the help of ProductDetails Api
              ...
              //calculating price with quantity ye jarha hai cart me
              ...
              CartModelBody cart = CartModelBody(
                ...
                // digitalVariantPrice: digitalVariantPrice
                  digitalVariantPrice: newpriceWithQuantity
                //isme
              ...
              print("Cart Model Before API Call: $cart");
              print("variantKey: $variantKey");
              print("newpriceWithQuantity: $newpriceWithQuantity");
                  ...
                  child: Column(children: [
                      Row(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          //yahan changes krna hai for Carttttttttttttttttttttttttt
                         //
                          //
                          //
                          //
                          ...
                          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            CustomDirectionalityWidget(
                              ...
                              // ),
                              child: Text("₹${pricwwithdiscount}"),
                            ),

                            widget.product?.discount != null && (widget.product?.discount ?? 0) > 0 ?
                            CustomDirectionalityWidget(
                              // child: Text(
                              ...
                              // ),
                             child: Text("₹${normalprice}", style: titilliumRegular.copyWith(color: Theme.of(context).hintColor,
                                 decoration: TextDecoration.lineThrough)
                             ),
                            )
                          ...
                          return CustomButton(isBuy:true,radius: 6,
                            ...
                            onTap:() {
                              if(configProvider.configModel?.guestCheckOut == 0 && !Provider.of<AuthController>(context, listen: false).isLoggedIn()){
                                ...
                                debugPrint("Cart goingggggggggg: $cart");
                                ...
                                //
                                //
                                //Addddddddddddddddddddddddddd to cart
