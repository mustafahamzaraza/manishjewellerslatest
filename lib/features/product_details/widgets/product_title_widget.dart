...
//                   buildPriceRow("92300/-\nRate/10gms", "6.040 gm", "₹$pricenew"),
//                   buildPriceRow("Making Charges", "", "₹8641"),
//                   buildPriceRow("Other Charges", "", "₹300"),
//                   buildPriceRow("Hallmarking Charges", "", "₹90"),
//                   buildPriceRow("GST", "", "₹1949.40", isHighlighted: true),
//                   const Divider(),
//                   buildPriceRow("Total", "", "₹66929", isBold: true),
//                 ],
//               ),
//             ),
//
...
//                           Padding(padding: EdgeInsets.all(6), child: Text("Pieces", style: TextStyle(fontWeight: FontWeight.bold))),
//                           Padding(padding: EdgeInsets.all(6), child: Text("Tone", style: TextStyle(fontWeight: FontWeight.bold))),
//                         ],
//                       ),
//                       const TableRow(
//                         children: [
//                           Padding(padding: EdgeInsets.all(6), child: Text("Jhumka Earring")),
//                           Padding(padding: EdgeInsets.all(6), child: Text("22K")),
//                           Padding(padding: EdgeInsets.all(6), child: Text("6.040 gm")),
//                           Padding(padding: EdgeInsets.all(6), child: Text("2")),
//                           Padding(padding: EdgeInsets.all(6), child: Text("Yellow")),
//                         ],
//                       ),
//                     ],
//                   )
