...
class CartModel {
  ...
  CartModel.fromJson(Map<String, dynamic> json) {
    ...
    freeDeliveryOrderAmount = json['free_delivery_order_amount'] != null
        ...
        : null;
    shop = json['shop'] != null
        ? Shop.fromJson(json['shop'], isAdminProduct: json['seller_is'] == 'admin')
        : null;
  ...
  @override
  String toString() {
    return 'CartModel(id: $id, productId: $productId, name: $name, seller: $seller, price: $price, quantity: $quantity, variant: $variant, color: $color)';
  }
}
...
class ProductInfo {
  ...
  @override
  String toString() {
    return 'ProductInfo(minimumOrderQty: $minimumOrderQty, totalCurrentStock: $totalCurrentStock)';
  }
}
...
class FreeDeliveryOrderAmount {
  ...
  @override
  String toString() {
    return 'FreeDeliveryOrderAmount(status: $status, amount: $amount, percentage: $percentage, shippingCostSaved: $shippingCostSaved, amountNeed: $amountNeed)';
  }
}
...
class CartModelBody {
  ...
  @override
  String toString() {
    return 'CartModelBody(productId: $productId, variant: $variant, color: $color, quantity: $quantity)';
  }
}
